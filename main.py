...
files = ['member_ups.dsx', 'hiea_de.dsx', 'hiea_lab.dsx', 'hiea_depression_demographic.dsx']
...
for f in files:
	...
	# If we are not removing editing the precision we just pass through the line
			else:
				print(line)
